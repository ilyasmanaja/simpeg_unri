...
@section('title', 'Data Diri Operator - SIMPEG UNRI')
            ...
            <div class="product-card mt-3">
                <div class="container py-5" style="max-width: 950px;">
                    <div class="settings-header">
                        <h1 class="section-title">Data Diri Operator</h1>
                        <p class="section-subtitle">Portal data diri Operator {{ $pegawai->prodi ?? 'Fakultas Teknik' }}.</p>
                    </div>
                    ...
                    <div class="mb-5">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            ...
                            <div class="d-flex gap-2">
                                <!-- Link Update Dinamis -->
                                <a href="{{ route('operator.pegawai.edit', $pegawai->id_pegawai) }}"
                                ...
                                <a href="{{ url('/operator/data-diri/create') }}" class="btn btn-danger btn-sm"
