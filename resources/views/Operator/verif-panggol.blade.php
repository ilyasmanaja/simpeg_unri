...
@section('title', 'Verifikasi Pangkat Golongan')
...
<div class="main">
  ...
  <div class="header-box">
    <div class="header-left">
      ...
      <div>
        <h1 class="page-title">Verifikasi Pangkat Golongan</h1>
  ...
  <div class="container-box">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane fade {{ request('tab') !== 'riwayat' ? 'show active' : '' }}" id="panel-antrean">
        <form method="GET" action="{{ url('operator/verifikasi/panggol') }}" class="row g-2 mb-3">
          ...
          <div class="antrean-list">
            @foreach($antrian as $item)
              @php
                ...
                $panggol   = $item->berkas->pangkatGolongan ?? null;
                $nama      = $pegawai?->nama ?? '-';
                $nip       = $pegawai?->nip ?? '-';
                $nidn      = $pegawai?->nidn ?? '-';
                $inisial   = strtoupper(implode('', array_map(fn($w) => $w[0], array_slice(explode(' ', $nama), 0, 2))));
                $panggolNm = $panggol?->nama_pangkat ?? ($panggol?->golongan ?? '-');
              ...
              <div class="antrean-row">
                ...
                <div class="antrean-info">
                  ...
                  <div class="antrean-meta">NIP: {{ $nip }} <span class="chip-jabatan">{{ $panggolNm }}</span></div>
                </div>
              ...
              <div class="detail-overlay" id="overlay-{{ $item->id_verifikasi }}">
                <div class="detail-modal">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="detail-grid">
                      <div class="detail-field"><span class="detail-label">Pangkat / Golongan Diajukan</span><span class="detail-val highlight">{{ $panggolNm }}</span></div>
                      <div class="detail-field"><span class="detail-label">Tanggal Pengajuan</span><span class="detail-val">{{ $tgl }}</span></div>
                      @if($panggol?->nomor_sk)
                        <div class="detail-field full"><span class="detail-label">Nomor SK</span><span class="detail-val">{{ $panggol->nomor_sk }}</span></div>
                      @endif
                    </div>
                      ...
                      <div class="berkas-list">
                        <div class="berkas-item">
                          ...
                          <div class="berkas-detail">
                            <span class="berkas-nama">Berkas Pangkat / Golongan</span>
      ...
      <div class="tab-pane fade {{ request('tab') === 'riwayat' ? 'show active' : '' }}" id="panel-riwayat">
        ...
        <div class="table-responsive custom-table">
          <table class="table data-table mb-0">
            <thead>
              <tr>
                <th>No</th><th>Nama Pegawai</th><th>Pangkat / Golongan Diajukan</th>
            ...
            <tbody>
              @forelse($riwayat as $i => $item)
                ...
                <tr>
                  ...
                  <td>{{ $panggol?->nama_pangkat ?? ($panggol?->golongan ?? '-') }}</td>
                  <td>
