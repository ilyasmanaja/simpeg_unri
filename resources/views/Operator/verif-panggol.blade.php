                        ...
                        <div class="antrean-list">
                            @foreach ($antrian as $item)
                                @php
                                    ...
                                    $panggolNm = $panggol?->jenis_pangkat ?? '-';
                                ...
                                <div class="antrean-row">
                                    ...
                                    <div class="antrean-info">
                                        ...
                                        <div class="antrean-meta">NIP: {{ $nip }} <span
                                                class="chip-jabatan">{{ $panggolNm }}</span></div>
                                    </div>
                                ...
                                <div class="detail-overlay" id="overlay-{{ $item->id_verifikasi }}">
                                    <div class="detail-modal">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="detail-grid">
                                                <div class="detail-field"><span class="detail-label">Pangkat / Golongan
                                                        Diajukan</span><span
                                                        class="detail-val highlight">{{ $panggolNm }}</span></div>
