    ...
    <div class="main">
        ...
        <div class="header-box">
            <div class="header-left">
                ...
                <div>
                    <h1 class="page-title">Persetujuan Surat Tugas</h1>
        ...
        <div class="container-box">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade {{ request('tab') !== 'riwayat' ? 'show active' : '' }}" id="panel-antrean">
                    <form method="GET" action="{{ route('pimpinan.persetujuan.surat-tugas') }}" class="row g-2 mb-3">
                                ...
                                <div class="detail-overlay" id="overlay-st-{{ $item->id_verifikasi }}">
                                    <div class="detail-modal">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="detail-grid">
                                                <div class="detail-field full">
                                                    ...
                                                    <span class="detail-val highlight">{{ $st?->perihal ?? '-' }}</span>
                                                </div>
                                                <div class="detail-field">
                                                    <span class="detail-label">Waktu Pelaksanaan</span>
                                                    <span class="detail-val">
                                                        {{ $st?->waktu_pelaksanaan ? \Carbon\Carbon::parse($st->waktu_pelaksanaan)->translatedFormat('d M Y') : '-' }}
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div id="tolak-st-{{ $item->id_verifikasi }}" style="display:none">
                                                ...
                                                <div class="tolak-block">
                                                    <div class="tolak-block-header" style="margin-bottom:10px">
                                                        ...
                                                        <div>
                                                            <div class="tolak-block-title">Catatan Penolakan <span
                                        ...
                                        <div class="panel-footer">
                                            {{-- SETUJU --}}
                                            <form method="POST"
                                                action="{{ route('pimpinan.persetujuan.setuju', $item->id_verifikasi) }}">
                                                @csrf
                            ...
                            <tbody>
                                @forelse($riwayat as $i => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge-status {{ $item->status_verifikasi === 'Disetujui' ? 'badge-ok' : 'badge-tolak' }}">
