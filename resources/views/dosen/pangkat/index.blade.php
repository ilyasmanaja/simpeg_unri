            ...
            <div class="jab-left">
                ...
                <div>
                    ...
                    @if ($pegawai && $pegawai->id_panggol)
                        <div class="jab-nama">{{ $pegawai->pangkatGolongan->jenis_pangkat ?? $pegawai->jenis_pangkat ?? '—' }}</div>
                    @else
                        ...
                        <td>
                            <div class="d-flex gap-1 flex-wrap">
                                ...
                                @if ($statusRaw === 'menunggu')
                                    ...
                                    <form action="{{ route('dosen.pangkat-golongan.destroy', $row->id_pengajuan) }}" method="POST" class="d-inline" id="form-delete-{{ $row->id_pengajuan }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-danger btn-aksi" onclick="confirmDelete({{ $row->id_pengajuan }})">
                ...
                <div class="detail-panel-body">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="info-row"><div class="info-label">Pangkat Saat Ini</div><p class="info-value" id="dp-pangkat-now">—</p></div>
                            <div class="info-row"><div class="info-label">Pangkat Diajukan</div><p class="info-value fw-bold" id="dp-pangkat-target">—</p></div>
