...
@section('title', 'Detail Data Diri Pegawai')
                ...
                <div class="mb-2">
                    <div class="d-flex justify-content-between align-items-center mb-1 flex-wrap gap-2">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            ...
                            <a href="{{ route('dosen.pegawai.password.form', $pegawai->id_pegawai) }}" class="btn btn-outline-secondary btn-sm" style="border-radius: 8px;">
                                <i class="bi bi-lock"></i> Ganti Password
                            </a>

                            @if(empty($pegawai->nomor_hp) || empty($pegawai->nomor_hp_darurat))
                                <a href="{{ route('dosen.pegawai.edit', $pegawai->id_pegawai) }}" class="btn btn-danger btn-sm" style="border-radius: 8px; background-color: var(--unri-red); border: none;">
                                    <i class="bi bi-plus-circle"></i> Lengkapi Biodata
                                </a>
                            @else
                                <a href="{{ route('dosen.pegawai.edit', $pegawai->id_pegawai) }}" class="btn btn-outline-danger btn-sm" style="border-radius: 8px;">
